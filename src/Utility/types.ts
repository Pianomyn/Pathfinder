...
export type VISITABLE_COLOR_MAPPINGS_TYPE =
  typeof VISITABLE_COLOR_MAPPINGS[keyof typeof VISITABLE_COLOR_MAPPINGS];
export type EXPLORED_COLOR_MAPPINGS_TYPE =
  typeof EXPLORED_COLOR_MAPPINGS[keyof typeof EXPLORED_COLOR_MAPPINGS];
